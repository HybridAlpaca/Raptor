...
int16 main (int16 argc, cchar argv[])
{
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("/home/cellman123/Desktop/Raptor/Engine/Assets/Icons/raptor-logo.png", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    basicShader.Bind();
    basicShader.Int("texture1", 0);
    basicShader.Int("texture2", 1);
